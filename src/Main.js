...
class Main extends Component
{
    ...
    constructor() 
    {
        ...
        [
            {
                id: `https://robohash.org/${Math.floor((Math.random() * 1000) + 1)}?200x200?200x200`,
                name: "Test Bot MK I",
                email: "botty@spacelysprockets.com"
                
            },
            {
                id: `https://robohash.org/${Math.floor((Math.random() * 1000) + 1)}?200x200`,
                name: "Test Bot MK II",
                email: "botty@spacelysprockets.com"
    ...
    render()
    {
        let robotCards = this.state.robots.map((robot,i) =>
            {
                 return(
